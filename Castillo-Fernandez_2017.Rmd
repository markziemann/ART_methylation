---
<<<<<<< HEAD:Castillo-Fernandez et al 2017.Rmd
...
date: "`r Sys.Date()`"
>>>>>>> 7e36e1e2b61ce248fdd73e68e28485039f2eaa0c:Castillo-Fernandez_2017.Rmd
output:
  html_document:
    toc: true
theme: cosmo
...
marker<- rownames(zz)
neff<- 4/sum(1/table(samplesheet$groups))
unmeth<- "T"
meth<- "C"
freq<- log2(zz$baseMean)
ce<- zz$log2FoldChange
se<- zz$lfcSE
pval<- zz$pvalue
data.frame("Row.names"=marker, "N"=neff, "unmeth"=unmeth, "meth"=meth, "CE"=ce, "SE"=se, "P.Value"=pval)
