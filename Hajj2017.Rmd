...
head(top_nat_vs_icsi_exc$fit)
head(top_nat_vs_icsi_exc$fit$coefficients)
head(top_nat_vs_icsi_exc$fit$SE)



# Output for Meta-analysis
write.table(top_nat_vs_icsi_exc$dma,file="hajj_top_nat_vs_icsi_exc.tsv",sep="\t",quote=FALSE) 
```
```
