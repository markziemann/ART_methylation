...
write.table(litzky_top_nat_vs_ivf_exc$dma,file="filename.tsv",sep="\t",quote=FALSE) 
```
...
# Output for Meta-analysis
write.table(litzky_top_nat_vs_sub_exc$dma,file="filename.tsv",sep="\t",quote=FALSE) 
```
...
head(top_sub_vs_ivf_exc$dmr)

# Output for Meta-analysis
write.table(litzky_top_sub_vs_ivf_exc$dma,file="filename.tsv",sep="\t",quote=FALSE) 
```
