...
write.table(top_nat_vs_fh_metal, file="novakovic_top_nat_vs_fh_metal.tsv",sep="\t",quote=FALSE, row.names = FALSE)

head(top_nat_vs_fh$dma)
head(top_nat_vs_fh$dmr)
head(top_nat_vs_fh_metal)

saveRDS(top_nat_vs_fh,file="top_nat_vs_fh.rds")
...
# Output for Meta-analysis
write.table(top_nat_vs_fz_metal, file="novakovic_top_nat_vs_fz_metal.tsv",sep="\t",quote=FALSE, row.names = FALSE)

head(top_nat_vs_fz$dma)
head(top_nat_vs_fz$dmr)
head(top_nat_vs_fz_metal)

saveRDS(top_nat_vs_fz,file="top_nat_vs_fz.rds")
...
# Output for Meta-analysis
write.table(top_nat_vs_GIFT_metal, file="novakovic_top_nat_vs_GIFT_metal.tsv",sep="\t",quote=FALSE, row.names = FALSE)

head(top_nat_vs_GIFT$dma)
head(top_nat_vs_GIFT$dmr)
head(top_nat_vs_GIFT_metal)

saveRDS(top_nat_vs_GIFT,file="top_nat_vs_GIFT.rds")
...
saveRDS(top_nat_vs_FX,file="top_nat_vs_FX.rds")
...
saveRDS(top_GIFT_vs_FX,file="top_GIFT_vs_FX.rds")
...
saveRDS(top_nat_vs_ART,file="top_nat_vs_ART.rds")
...
saveRDS(top_fh_vs_fz,file="top_fh_vs_fz.rds")
