...
write.table(top_nat_vs_fh$dma,file="novakovic_top_nat_vs_fh.tsv",sep="\t",quote=FALSE)
```
...
write.table(top_nat_vs_fz$dma,file="novakovic_top_nat_vs_fz.tsv",sep="\t",quote=FALSE)
```
...
write.table(top_nat_vs_GIFT$dma,file="novakovic_top_nat_vs_GIFT.tsv",sep="\t",quote=FALSE)
```
...
write.table(top_nat_vs_FX$dma,file="novakovic_top_nat_vs_FX.tsv",sep="\t",quote=FALSE)
```
...
write.table(top_fh_vs_fz$dma,file="novakovic_top_fh_vs_fz.tsv",sep="\t",quote=FALSE)
```
