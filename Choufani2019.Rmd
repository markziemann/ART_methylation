...
head(top_NA_vs_invitro_exc$dmr)
```
...
head(top_invivo_vs_invitro_exc$dmr)
```
## Natural vs ICSI
...
## NAT vs HYPO
```{r,Nat_vs_Hypo_exc, fig.width = 8 ,fig.height = 8, fig.cap="Figure 9: Differential analysis: Natural vs Hypofertile, excluding sex chromosomes"}
#Exclude Sex Chromosomes
