...
## Nat vs In vitro
```{r,nat_vs_in_vitro_incl, fig.width = 8 ,fig.height = 8, fig.cap="Figure 8: Differential analysis: Naturally conceived vs in vitro including sex chromosomes"}
# Include Sex Chromosomes
...
## Nat vs ART
```{r,ART_vs_Control_incl, fig.width = 8 ,fig.height = 8, fig.cap="Figure 10: Differential analysis: Naturally conceived vs ART including sex chromosomes"}
# Include Sex Chromosomes
samplesheet <- targets
...
## in vitro vs in vivo
```{r,in_vivo_vs_in_vitro_incl,fig.width = 8 ,fig.height = 8, fig.cap="Figure 12: Differential analysis: in vitro vs in vivo including sex chromosomes"}
# Include Sex Chromosomes
