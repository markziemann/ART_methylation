...
head(top_NA_vs_invitro_exc)
```

# Nat vs ART
```{r,ART_vs_Control_incl}
# Include Sex Chromosomes
samplesheet <- targets
...
head(top_invivo_vs_invitro_inc)
```

```{r,invivo_vs_invitro_exc}
# Exclude Sex Chromosomes
samplesheet <- subset(targets,`art treatment:ch1`=="in vivo" | `art treatment:ch1`=="in vitro")
samplesheet$Basename <- sapply(strsplit(samplesheet$Basename, "/"), "[[", 3)
str(samplesheet)
